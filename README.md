...
>_Passing 'default' as document-path-root assigns a working default path to the webserver._

Whilte running the webserver will respond to requests adhering to http/0.9 with the requested document, if it exists. Otherwise the response will be a coresponding http error. 
